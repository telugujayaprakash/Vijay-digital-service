      ...
      <div className='container mx-auto px-4 relative z-10'>
        ...
        <div className='mt-16 bg-gradient-to-br from-gray-800/90 via-gray-900/95 to-gray-800/90 backdrop-blur-xl rounded-2xl p-8 md:p-12 border border-cyan-400/20 shadow-2xl shadow-cyan-400/10 relative overflow-hidden'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8 text-center relative z-10'>
            ...
            <div className='group'>
              <p className='text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300'>
                200+
              </p>
              <p className='text-purple-200 font-medium'>Projects Completed</p>
            </div>
            <div className='group'>
              <p className='text-4xl md:text-5xl font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300'>
                10M+
              </p>
              <p className='text-green-200 font-medium'>Revenue Generated</p>
            </div>
            <div className='group'>
              <p className='text-4xl md:text-5xl font-bold bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300'>
                10+
              </p>
