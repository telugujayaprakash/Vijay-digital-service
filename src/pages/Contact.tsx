          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="bg-gradient-to-br from-gray-800/95 via-gray-900/95 to-gray-800/95 backdrop-blur-xl rounded-2xl p-8 border border-emerald-400/20 shadow-2xl shadow-emerald-400/10">
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium mb-2 text-emerald-200">First Name</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium mb-2 text-emerald-200">Last Name</label>
                      <input
                        type="text"
                        className="w-full px-4 py-3 rounded-lg border border-emerald-400/30 bg-gray-800/50 backdrop-blur-sm text-white placeholder-gray-400 focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400 outline-none transition-all"
                        placeholder="Doe"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-emerald-200">Email</label>
                    <input
                      type="email"
                      className="w-full px-4 py-3 rounded-lg border border-emerald-400/30 bg-gray-800/50 backdrop-blur-sm text-white placeholder-gray-400 focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400 outline-none transition-all"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-emerald-200">Subject</label>
                    <input
                      type="text"
                      className="w-full px-4 py-3 rounded-lg border border-emerald-400/30 bg-gray-800/50 backdrop-blur-sm text-white placeholder-gray-400 focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400 outline-none transition-all"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-emerald-200">Message</label>
                    <textarea
                      rows={5}
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-white via-emerald-100 to-green-100 bg-clip-text text-transparent">Get in touch</h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-br from-gray-800/50 via-gray-900/50 to-gray-800/50 backdrop-blur-sm border border-teal-400/20 hover:border-teal-400/40 transition-all duration-300 group">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1 text-white group-hover:text-teal-100 transition-colors duration-300">Office Address</h3>
                      <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">123 Marketing Street, Digital City, DC 10001</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-br from-gray-800/50 via-gray-900/50 to-gray-800/50 backdrop-blur-sm border border-emerald-400/20 hover:border-emerald-400/40 transition-all duration-300 group">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1 text-white group-hover:text-emerald-100 transition-colors duration-300">Phone</h3>
                      <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">+1 (234) 567-890</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-br from-gray-800/50 via-gray-900/50 to-gray-800/50 backdrop-blur-sm border border-cyan-400/20 hover:border-cyan-400/40 transition-all duration-300 group">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1 text-white group-hover:text-cyan-100 transition-colors duration-300">Email</h3>
                      <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">hello@digipro.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-br from-gray-800/50 via-gray-900/50 to-gray-800/50 backdrop-blur-sm border border-green-400/20 hover:border-green-400/40 transition-all duration-300 group">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1 text-white group-hover:text-green-100 transition-colors duration-300">Business Hours</h3>
                      <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">Monday - Friday: 9:00 AM - 6:00 PM</p>
                    </div>
                  </div>
                </div>
              </div>
