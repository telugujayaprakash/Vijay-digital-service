  ...
  const strategies = [
    {
      ...
      description:
        "Develop comprehensive content strategies that align with your business goals and audience needs.",
      details: [
    ...
    },
    {
      ...
      title: "SEO Content",
      description:
        "Create optimized content that ranks well in search engines while providing value to readers.",
      details: [
    ...
    },
    {
      ...
      description:
        "Amplify your content reach through strategic distribution across multiple channels.",
      details: [
    ...
    },
    {
      ...
      description:
        "Track content performance and optimize strategies based on data-driven insights.",
      details: [
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-slate-800 tracking-tight">
                Content <span className="text-primary">Marketing</span>
              </h1>
              <p className="text-xl text-slate-500 max-w-3xl mx-auto mb-8">
                Tell your story through compelling content that educates,
                engages, and converts. We create comprehensive content
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-8 md:mb-8">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Content Types We <span className="text-primary">Create</span>
              </h2>
              <p className="text-slate-600 max-w-2xl mx-auto">
                We produce engaging content across all formats to connect with
                your audience.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-8 md:mb-8">
              ...
              <p className="text-slate-500 max-w-2xl mx-auto">
                End-to-end content marketing solutions that drive engagement and
                conversions.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Why Content{" "}
                  <span className="text-primary">Marketing Works</span>
                </h2>
                <p className="text-slate-600 mb-8">
                  Content marketing builds trust, authority, and long-term
              ...
              <div className="card-soft p-8 md:p-10 relative overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-slate-500">Lead Increase</p>
                  </div>
                  <div className="text-center">
        ...
        <section className="py-12 md:py-8 bg-slate-50 relative overflow-hidden">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-slate-600 mb-8 max-w-2xl mx-auto">
              Let's develop a content strategy that positions your brand as an
              industry leader.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact">
