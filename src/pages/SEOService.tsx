          ...
          <div className='container mx-auto px-4'>
            <div className='max-w-4xl mx-auto text-center'>
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                <Button
                  size='lg'
                  className='bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-semibold shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300 transform hover:scale-105 border border-orange-400/50 hover:border-orange-400/70'
                >
                  Get SEO Audit
                ...
                <Button
                  size='lg'
                  variant='outline'
                  className='border-orange-400/50 text-orange-300 hover:bg-gradient-to-r hover:from-orange-500/20 hover:to-red-500/20 hover:border-orange-400/70 hover:text-white font-semibold shadow-lg shadow-orange-400/20 hover:shadow-orange-400/30 transition-all duration-300 transform hover:scale-105'
                >
                  View Case Studies
                </Button>
              </div>
          ...
          <div className='container mx-auto px-4'>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
              {strategies.map((strategy, index) => (
                <div
                  key={index}
                  className='bg-gradient-to-br from-gray-800/95 via-gray-900/95 to-gray-800/95 backdrop-blur-xl rounded-2xl p-8 border border-orange-400/20 hover:border-orange-400/50 shadow-lg hover:shadow-2xl hover:shadow-orange-400/20 transition-all duration-500 hover:-translate-y-2 group'
                >
          ...
          <div className='container mx-auto px-4 text-center'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              ...
              <Link to='/services'>
                <Button
                  size='lg'
                  className='bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white font-semibold shadow-lg shadow-red-500/30 hover:shadow-red-500/50 transition-all duration-300 transform hover:scale-105 border border-red-400/50 hover:border-red-400/70'
                >
                  View All Services
                </Button>
              </Link>
