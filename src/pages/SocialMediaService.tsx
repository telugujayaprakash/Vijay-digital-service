...
const SocialMediaPage = () => {
  const strategies = [
    {
      ...
      description:
        "Create engaged communities around your brand through authentic interactions and valuable content.",
      details: [
    ...
    },
    {
      ...
      description:
        "Develop compelling content calendars that resonate with your target audience and drive engagement.",
      details: [
    ...
    },
    {
      ...
      description:
        "Maximize your reach and engagement with data-driven paid social media campaigns.",
      details: [
        "Audience targeting",
    ...
    },
    {
      ...
      description:
        "Track performance metrics and optimize strategies based on real-time data insights.",
      details: [
  ...
  const platforms = [
    ...
    { name: "Twitter/X", reach: "500M+", color: "bg-slate-100" },
      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-slate-800 tracking-tight">
                Social Media <span className="text-primary">Marketing</span>
              </h1>
              <p className="text-xl text-slate-500 max-w-3xl mx-auto mb-8">
                Build meaningful connections with your audience across all
                social platforms. We create engaging content and strategies that
                drive real results.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-8 md:mb-8">
              ...
              <p className="text-slate-600 max-w-2xl mx-auto">
                We leverage the power of all major social media platforms to
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {platforms.map((platform, index) => (
                <div
                  key={index}
                  className="bg-slate-100 rounded-2xl p-6 border border-gray-700 text-center"
                >
                  <div
                    className={`w-12 h-12 rounded-xl ${platform.color} flex items-center justify-center mx-auto mb-4`}
                  >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-8 md:mb-8">
              ...
              <p className="text-slate-500 max-w-2xl mx-auto">
                Comprehensive strategies designed to build your brand presence
            ...
            <div className="grid lg:grid-cols-2 gap-6 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Why Social Media{" "}
                  <span className="text-primary">Marketing Matters?</span>
                </h2>
                <p className="text-slate-600 mb-8">
                  Social media is where your customers are. We help you connect,
                  engage, and convert.
                </p>
        ...
        <section className="py-12 md:py-8 bg-slate-50 relative overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8 md:mb-8">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Our Social Media <span className="text-primary">Process</span>
              </h2>
              <p className="text-slate-600 max-w-2xl mx-auto">
              ...
              {[
                {
                  ...
                  desc: "Analyze your current presence and competitors",
                },
                {
                  step: "02",
                  title: "Content Planning",
                  desc: "Create engaging content calendars",
                },
                {
                  step: "03",
                  title: "Community Management",
                  desc: "Build and nurture your online community",
                },
                {
                  step: "04",
                  title: "Growth & Analytics",
                  desc: "Scale presence and measure performance",
                },
              ].map((item, index) => (
